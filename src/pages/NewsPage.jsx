...
export default function NewsPage() {
  ...
  return (
    <main className="pt-20 bg-slate-50 min-h-screen">
      ...
      {/* Hero Section */}
      {/* Hero Section */}
      <section className="relative px-4 sm:px-6 lg:px-8 py-16 sm:py-24 bg-[#FDFBF7] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <h1 className="flex flex-col items-center justify-center font-black tracking-tight select-none mb-8">
              ...
              {/* Line 1: ACTUALITÉS (Yellow Sticker) */}
              ...
              {/* Line 2: & (Neutral) ÉVÉNEMENTS (Blue Sticker) */}
